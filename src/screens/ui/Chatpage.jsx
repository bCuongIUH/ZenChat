...
//   const [homemess, setHomemess] = useState(null);
...
//     // Cập nhật giá trị receiver trong useEffect dựa trên dữ liệu từ friend và existingRoom
//   //   useEffect(() => {
//   //     // Xác định giá trị receiver dựa trên existingRoom
//   //     if (existingRoom) {
//   //       setReceiver(existingRoom.creator._id !== user._id);
//   //     }
//   //   }, [existingRoom, user]);
...
//   // //
//   const friend = (userId) => {
//     // Logic để xác định liệu userId có phải là bạn bè của user không
...
//   //       recipient: existingRoom.recipient.sended, // Sửa từ setRecipient sang existingRoom.recipient.sended
//   //       sender: existingRoom.creator.sended, // Sửa từ setSender sang existingRoom.creator.sended
...
//     if (!room.creator || !room.recipient) {
//         return false; // Loại bỏ phòng không có thông tin creator hoặc recipient
//     }
...
//             const friendStatus = friend(displayUser._id);
//             // Thêm trường isFriend vào object displayUser
//             displayUser.friend = friendStatus;
//             return (
//               <TouchableOpacity
