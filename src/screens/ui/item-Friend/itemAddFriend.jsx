...
//   const regexPatterns = {
//     phoneNumber: /^(0|\+84)[1-9][0-9]{8}$/, // Sửa biểu thức chính quy
//   };
...
//       {/* {authFound.map((auth) => (
//         <View key={auth._id} style={styles.userInfoContainer}>
