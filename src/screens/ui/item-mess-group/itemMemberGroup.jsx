...
console.log(group.creator.fullName);
  //kich nhóm
          ...
          renderItem={({ item }) => (
            <View style={styles.memberItem}>
              ...
              <Text style={styles.memberName}>
                {item._id === group.creator._id
                  ? group.creator.fullName
                  : item.fullName}
                {item._id === group.creator._id && " (Chủ phòng)"}
              </Text>
              {item._id !== group.creator._id && (
                <TouchableOpacity
                  style={styles.kickButton}
                  onPress={() => onClickKick(item._id)}
                >
